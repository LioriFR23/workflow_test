...
- **local_file**: Creates a simple text file with predefined content
...
- **content**: Change the text content in the `content` attribute
- **filename**: Modify the output file name and path
- **file permissions**: Add `file_permission` attribute (default is "0777")
